...
def main():
    ...
    if len(args) == 2 and args[0] == '-plane' and args[1] in planes_:
        ...
        outpath = "C:\\Users\\vanth\\Desktop\\Workspace\\AUTOENCODER\\processed_data\\"
        np.save(outpath + "mean_" + wireplane, mean)
        print('--> mean saved to', outpath + "mean_" + wireplane)

        np.save(outpath + "std_" + wireplane, std)
        print('--> std saved to', outpath + "std_" + wireplane)
